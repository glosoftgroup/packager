...
def generate_license():
    ...
    end_month_date = '2018-02-28'
    date_format = "%Y-%m-%d"
    number_of_days = (datetime.strptime(end_month_date, date_format) - datetime.strptime(date_today, date_format)).days

    end_date = (datetime.today() + timedelta(days=number_of_days)).date().isoformat()
