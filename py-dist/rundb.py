...
if __name__ == '__main__':
    ...
    for i in range(1, 11):
        ...
        while time.time() < t + 0.1:
            ...
            configsys.processconfiguration()

    proc = subprocess.Popen(['python','..\\' + project_dir_name + '\manage.pyc','runserver','127.0.0.1:8000'])
    print("[pyqt.py] PyQt version 1: %s" % QtCore.PYQT_VERSION_STR)
